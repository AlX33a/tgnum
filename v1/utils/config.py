...
def load_config(profile: str, path: str = None) -> dict:
    ...
    required = ["graphql_url","collection_address","count",
    ...
    try:
        ...
        cfg["notify_interval_seconds"] = int(cfg.get("notify_interval_seconds",60))
        cfg["floor_threshold_percent"] = float(cfg.get("floor_threshold_percent",4))
